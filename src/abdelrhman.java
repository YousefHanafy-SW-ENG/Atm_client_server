 ...
 * @author abdelrhman
 */
public class abdelrhman extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(TransferBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 211, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(DepositeBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(WithdrawBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(DepositeBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(CheckBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(TransferBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(WithdrawBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(92, 92, 92)
    ...
    try {
         String  exit="Ea";
             ...
             Logger.getLogger(abdelrhman.class.getName()).log(Level.SEVERE, null, ex);
         }
        dispose(); 
    }   
...
String msg = JOptionPane.showInputDialog("Enter Withdraw Value here");
         try {
             data_output_stream.writeUTF("wa"+msg);
         } catch (IOException ex) {
             Logger.getLogger(abdelrhman.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    private void DepositeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DepositeBtnActionPerformed
         ...
         try {
             data_output_stream.writeUTF("da"+msg);
         } catch (IOException ex) {
             Logger.getLogger(abdelrhman.class.getName()).log(Level.SEVERE, null, ex);
         }
                    JOptionPane.showMessageDialog(msgPanel,"abdelrhman Deposited Successfully ");      
                                            
    }//GEN-LAST:event_DepositeBtnActionPerformed

    private void CheckBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckBtnActionPerformed
      try {
             data_output_stream.writeUTF("ca");
             JOptionPane.showMessageDialog(msgPanel,"abdelrhman Checked Balance ");
         } catch (IOException ex) {
             Logger.getLogger(abdelrhman.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    private void TransferBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TransferBtnActionPerformed
                     String msg1 = JOptionPane.showInputDialog("2 to ziad\\n 3 to youssef\\n 4 to hassan");
        String msg2 = JOptionPane.showInputDialog("Amount to transfer");
         try {
             data_output_stream.writeUTF("ta"+msg1+msg2);
         } catch (IOException ex) {
    ...
    public static void main(String args[])throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(abdelrhman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new abdelrhman().setVisible(true);
            }
        });
       ...
       BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); 
        ...
        if(Server_Id.equals("abdelrhman")&&Server_Password.equals("1"))
            {

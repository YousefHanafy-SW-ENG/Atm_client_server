 ...
 * @author hassan
 */
public class hassan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(CheckBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(TransferBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(WithdrawBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE))
                .addContainerGap())
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(24, 24, 24)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(WithdrawBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    try {
         String  exit="Ea";
             ...
             Logger.getLogger(hassan.class.getName()).log(Level.SEVERE, null, ex);
         }
        dispose(); 
    }   
...
String msg = JOptionPane.showInputDialog("Enter Withdraw Value here");
         try {
             data_output_stream.writeUTF("wh"+msg);
         } catch (IOException ex) {
             Logger.getLogger(hassan.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    private void DepositeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DepositeBtnActionPerformed
         ...
         try {
             data_output_stream.writeUTF("dh"+msg);
         } catch (IOException ex) {
             Logger.getLogger(hassan.class.getName()).log(Level.SEVERE, null, ex);
         }
                    JOptionPane.showMessageDialog(msgPanel,"Hassan Deposited Successfully ");      
                                            
    }//GEN-LAST:event_DepositeBtnActionPerformed

    private void CheckBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckBtnActionPerformed
      try {
             data_output_stream.writeUTF("ch");
             JOptionPane.showMessageDialog(msgPanel,"Hassan Checked Balance ");
         } catch (IOException ex) {
             Logger.getLogger(hassan.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    private void TransferBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TransferBtnActionPerformed
        ...
        String msg2 = JOptionPane.showInputDialog("Amount to transfer");
         try {
             data_output_stream.writeUTF("th"+msg1+msg2);
         } catch (IOException ex) {
    ...
    public static void main(String args[])throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hassan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); 
        ...
        if(Server_Id.equals("hassan")&&Server_Password.equals("1"))
            {

 ...
 * @author youssef
 */
public class youssef extends javax.swing.JFrame {
...
String msg = JOptionPane.showInputDialog("Enter Withdraw Value here");
         try {
             data_output_stream.writeUTF("wm"+msg);
         } catch (IOException ex) {
             Logger.getLogger(youssef.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    private void DepositeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DepositeBtnActionPerformed
         ...
         try {
             data_output_stream.writeUTF("dm"+msg);
         } catch (IOException ex) {
             Logger.getLogger(youssef.class.getName()).log(Level.SEVERE, null, ex);
         }
                    JOptionPane.showMessageDialog(msgPanel,"Youssef Deposited Successfully ");      
                                            
    }//GEN-LAST:event_DepositeBtnActionPerformed

    private void CheckBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckBtnActionPerformed
      try {
             data_output_stream.writeUTF("cm");
             JOptionPane.showMessageDialog(msgPanel,"Youssef Checked Balance ");
         } catch (IOException ex) {
             Logger.getLogger(youssef.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    private void TransferBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TransferBtnActionPerformed
        ...
        String msg2 = JOptionPane.showInputDialog("Amount to transfer");
         try {
             data_output_stream.writeUTF("ty"+msg1+msg2);
         } catch (IOException ex) {
             Logger.getLogger(youssef.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    public static void main(String args[])throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(youssef.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
       ...
       BufferedReader br = new BufferedReader(new InputStreamReader(System.in)); 
        ...
        if(Server_Id.equals("youssef")&&Server_Password.equals("1"))
            {
